...
export function googleFontHref(theme: Theme) {
  ...
  return `https://fonts.googleapis.com/css2?family=${headerFont}&family=${bodyFont}&family=${codeFont}&display=fallback`
}
...
export function googleFontSubsetHref(theme: Theme, text: string) {
  ...
  return `https://fonts.googleapis.com/css2?family=${titleFont}&text=${encodeURIComponent(text)}&display=fallback`
}
