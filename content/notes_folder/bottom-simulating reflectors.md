...
draft: false
---
A bottom-simulating reflector (BSR) is an echo in the ocean floor that marks where sediment layers meet hidden layers beneath the surface. Imagine a deep-sea sonar sending out signals, bouncing back from the interface between gas [[clathrate|hydrate]] deposits (solidified natural gas) and the sedimentary layers underneath. That return signal is the BSR, a crucial tool for those who are trying to understand submarine geology, ocean floor structures, and energy resources.
