...
draft: true
---
Molecules are assemblies of atoms, and they're the fundamental units of chemistry: the air we breathe, the DNA in our cells, the water in the ocean, the proteins that keep us running.%% , responsible for all the complexity and diversity of matter. %%

A molecule is just two or more atoms bonded together, held in place by the electrons shared between them. These atomic bonds come in different flavors: covalent bonds, where atoms share [[electrons]] (like in water, H₂O), and ionic bonds, where oppositely charged atoms stick together (like in table salt, NaCl). Some molecules are simple—oxygen (O₂), nitrogen (N₂), or carbon dioxide (CO₂)—while others are vast, complex structures like proteins, DNA, and synthetic polymers.
