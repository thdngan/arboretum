...
When you look at [[ocean worlds|places]] like Titan, Triton, or maybe even Pluto, you've got to wonder how they ended up with the volatiles they have. Clathrates might have stored volatiles while these bodies formed and released them later. New observational techniques might also give the first direct evidence of clathrates on other bodies.
...
- The slow kinetics of clathrate formation, @Barrer1967 found that clathrates form much more efficiently when you shake things up, exposing fresh ice to the gas.
...
Despite all this, there is still no direct evidence of clathrates beyond Earth. In reflection spectra they look much like ordinary water ice, which makes them hard to spot, but new ground-based spectroscopy might be able to tell the two apart.
...
Most of the guest-host attraction comes from London dispersion forces [@Fowler1960], with minor contributions from dipole-induced dipole and dipole-dipole interactions. Even noble gases get trapped in clathrate cages [@vanderWaals1959], held only by these weak forces. Strongly dipolar molecules can also fit inside, but that's a discussion for another section.

## Modeling clathrate formation (Lunine & Stevenson, 1985)
