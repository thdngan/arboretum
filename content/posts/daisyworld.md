...
Daisyworld is imaginary, but the point it makes is still very relevant to our reality. Too much change, from natural cycles or from us, can push the system in ways that are hard to predict, and the feedback loops are what decide how much it can take.
